...
const teamLeaderboard = [
  ...
  { name: "我朋友說想湊個50人的隊", tickets: "56", note: "持續增加中" },
  { name: "波士頓台灣媽媽親子會", tickets: "43", note: "持續增加中" },
  ...
  { name: "波士頓台灣世衛協進會", tickets: "10+", note: "持續增加中" },
  { name: "當偶們同在一起", tickets: "10+", note: "持續增加中" },
  ...
  { name: "Taiwan Film Festival of Boston", tickets: "", note: "持續增加中" },
  { name: "Taiwan 襪 Up!", tickets: "", note: "持續增加中" },
  { name: "Woo告台", tickets: "", note: "持續增加中" },
  { name: "從南到北 襪ㄧ下！", tickets: "", note: "持續增加中" },
  { name: "波士頓北一女校友會", tickets: "", note: "持續增加中" },
  { name: "襪賽！Taiwan", tickets: "", note: "持續增加中" },
  { name: "金余", tickets: "", note: "持續增加中" },
  { name: "飛天少女豬", tickets: "", note: "持續增加中" },
  { name: "Tide One Pioneers (TOP) 台灣拓荒者船隊", tickets: "", note: "持續增加中" },
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-emerald-50/40 to-white text-slate-900">
      ...
      <main>
        <section id="home" className="relative overflow-hidden px-4 py-16 md:px-8 md:py-24">
          ...
          <div className="relative mx-auto mb-10 max-w-7xl rounded-3xl border border-amber-300 bg-amber-50 p-6 shadow-lg md:p-8">
            <p className="text-sm font-black uppercase tracking-[0.25em] text-amber-700">
              Important Notice
            </p>

            <h2 className="mt-2 text-3xl font-black text-slate-950">
              🎟 售票暫停公告 Ticket Sales Temporarily Paused
            </h2>

            <div className="mt-5 space-y-5 text-base leading-8 text-slate-700">
              <div>
                  <p className="mt-2">
                  大家好，不好意思，我們需要先暫時關閉售票。
                </p>

                <p className="mt-3">
                  因為大家真的太支持了！真的非常感謝大家！活動公布才短短 8 天，
                  紅襪原本提供給我們「包含限量 Jersey」的票券額度就已經全數用完。
                </p>

                <p className="mt-3">
                  我原本以為這個額度至少可以撐到 5/31，沒想到大家的支持遠遠超出預期。
                  由於限量 Jersey 的數量是固定的，目前我們正在等紅襪回覆，
                  確認他們是否還能再提供更多「含限量 Jersey」的票券額度。
                  他們表示需要先確認庫存後才能回覆我們。
                </p>

                <p className="mt-3">
                  真的很不好意思，這是我們一開始沒有預想到的狀況。
                  需要特別說明的是：我們和紅襪保留的座位票數仍然是足夠的，
                  但「有附限量 Jersey」的票券數量是有限的。
                </p>

                <p className="mt-3">
                  等紅襪確認後，我們會在第一時間通知大家後續購票方式。
                  謝謝大家的理解，也再次感謝大家讓 912 台灣集結這麼快就衝出驚人的支持度！
                </p>
              </div>

              <div className="border-t border-amber-200 pt-5 mt-5">
                  <p className="mt-2">
                  Hello everyone, we sincerely apologize, but we need to temporarily pause ticket sales.
                </p>

                <p className="mt-3">
                  The support from the community has been absolutely incredible — thank you all so much!
                  In just 8 days after announcing the event, the entire allocation of tickets that included
                  the limited-edition Red Sox × Bruins Jersey has already sold out.
                </p>

                <p className="mt-3">
                  We originally expected this allocation to last at least until May 31,
                  but the response far exceeded our expectations. Since the limited Jersey quantity is fixed,
                  we are currently waiting for the Red Sox to confirm whether additional Jersey ticket allocations
                  may still be available. They have informed us that they need to first check their inventory before
                  providing an answer.
                </p>

                <p className="mt-3">
                  We truly apologize for this unexpected situation. We would like to clarify that there are still
                  enough reserved seats available for our group, but the number of tickets that include the limited
                  Jersey is limited.
                </p>

                <p className="mt-3">
                  Once we receive confirmation from the Red Sox, we will immediately update everyone regarding the
                  next phase of ticket sales. Thank you again for your understanding and for the overwhelming support
                  that has made 912 Taiwan Fan Night at Fenway grow so quickly.
                </p>
              </div>
            </div>

            <p className="mt-6 text-right text-sm font-bold text-slate-600">
              波克萊台灣商會基金會 BTCF<br />
              5/12/2026
            </p>
          </div>
            ...
            <Card className="overflow-hidden border-emerald-200 bg-white shadow-lg">
              ...
              <div className="p-6 md:p-8">
                <div className="rounded-[2rem] border border-emerald-100 bg-gradient-to-br from-emerald-50 via-white to-sky-50 p-6 md:p-10">
                  <div className="relative mx-auto hidden min-h-[1850px] max-w-6xl md:block">
                    {teamLeaderboard.map((team, index) => {
                      const bubbleStyles = [
                        "absolute left-[35%] top-[500px] h-80 w-80 bg-emerald-700 text-white ring-8 ring-emerald-100",
                        "absolute left-[20%] top-[910px] h-72 w-72 bg-rose-500 text-white ring-8 ring-rose-100",
                        "absolute left-[5%] top-[80px] h-64 w-64 bg-sky-600 text-white ring-8 ring-sky-100",
                        "absolute right-[6%] top-[80px] h-56 w-56 bg-blue-600 text-white ring-8 ring-blue-100",
                        "absolute left-[51%] top-[125px] h-56 w-56 bg-orange-500 text-white ring-8 ring-orange-100",
                        "absolute right-[12%] top-[430px] h-44 w-44 bg-emerald-500 text-white ring-8 ring-emerald-100",
                        "absolute left-[4%] top-[380px] h-44 w-44 bg-teal-600 text-white ring-8 ring-teal-100",
                        "absolute right-[4%] top-[700px] h-40 w-40 bg-pink-500 text-white ring-8 ring-pink-100",
                        "absolute left-[3%] top-[650px] h-44 w-44 bg-red-500 text-white ring-8 ring-red-100",
                        "absolute right-[18%] top-[990px] h-40 w-40 bg-lime-600 text-white ring-8 ring-lime-100",
                        "absolute left-[26%] top-[230px] h-36 w-36 bg-violet-600 text-white ring-8 ring-violet-100",
                        "absolute right-[31%] top-[350px] h-36 w-36 bg-emerald-600 text-white ring-8 ring-emerald-100",
                        "absolute left-[6%] top-[1180px] h-36 w-36 bg-purple-600 text-white ring-8 ring-purple-100",
                        "absolute right-[4%] top-[1180px] h-36 w-36 bg-rose-500 text-white ring-8 ring-rose-100",
                        "absolute left-[35%] top-[125px] h-36 w-36 bg-cyan-600 text-white ring-8 ring-cyan-100",
                        "absolute left-[47%] top-[850px] h-36 w-36 bg-indigo-600 text-white ring-8 ring-indigo-100",
                        "absolute right-[33%] top-[1180px] h-36 w-36 bg-teal-600 text-white ring-8 ring-teal-100",
                        "absolute left-[23%] top-[1265px] h-36 w-36 bg-fuchsia-600 text-white ring-8 ring-fuchsia-100",
                        "absolute left-[45%] top-[1320px] h-36 w-36 bg-purple-600 text-white ring-8 ring-purple-100",
                        "absolute right-[18%] top-[1340px] h-36 w-36 bg-orange-500 text-white ring-8 ring-orange-100",
                        "absolute left-[8%] top-[1420px] h-32 w-32 bg-amber-500 text-white ring-8 ring-amber-100",
                        "absolute right-[4%] top-[1450px] h-32 w-32 bg-yellow-500 text-white ring-8 ring-yellow-100",
                        "absolute left-[35%] top-[1490px] h-40 w-40 bg-slate-700 text-white ring-8 ring-slate-200",
                      ];
