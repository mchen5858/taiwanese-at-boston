...
const teamLeaderboard = [
  ...
  { name: "我朋友說想湊個50人的隊", tickets: "47", note: "持續增加中" },
            ...
            <Card className="overflow-hidden border-emerald-200 bg-white shadow-lg">
              ...
              <div className="p-6 md:p-8">
                <div className="rounded-[2rem] border border-emerald-100 bg-gradient-to-br from-emerald-50 via-white to-sky-50 p-6 md:p-10">
                  <div className="relative mx-auto hidden min-h-[1520px] max-w-6xl md:block">
                    {teamLeaderboard.map((team, index) => {
                      const bubbleStyles = [
                        "absolute left-[35%] top-[340px] h-80 w-80 bg-emerald-700 text-white ring-8 ring-emerald-100",
                        "absolute left-[18%] top-[710px] h-72 w-72 bg-rose-500 text-white ring-8 ring-rose-100",
                        "absolute left-[4%] top-[40px] h-72 w-72 bg-sky-600 text-white ring-8 ring-sky-100",
                        "absolute right-[5%] top-[40px] h-56 w-56 bg-sky-600 text-white ring-8 ring-sky-100",
                        "absolute left-[51%] top-[95px] h-56 w-56 bg-orange-500 text-white ring-8 ring-orange-100",
                        "absolute left-[4%] top-[350px] h-44 w-44 bg-cyan-600 text-white ring-8 ring-cyan-100",
                        "absolute right-[10%] top-[470px] h-44 w-44 bg-emerald-500 text-white ring-8 ring-emerald-100",
                        "absolute right-[2%] top-[300px] h-36 w-36 bg-pink-500 text-white ring-8 ring-pink-100",
                        "absolute right-[18%] top-[700px] h-40 w-40 bg-lime-600 text-white ring-8 ring-lime-100",
                        "absolute left-[52%] top-[790px] h-40 w-40 bg-violet-600 text-white ring-8 ring-violet-100",
                        "absolute left-[4%] top-[760px] h-36 w-36 bg-emerald-600 text-white ring-8 ring-emerald-100",
                        "absolute right-[3%] top-[925px] h-36 w-36 bg-purple-600 text-white ring-8 ring-purple-100",
                        "absolute right-[14%] top-[1120px] h-36 w-36 bg-rose-500 text-white ring-8 ring-rose-100",
                        "absolute left-[31%] top-[65px] h-32 w-32 bg-violet-600 text-white ring-8 ring-violet-100",
                        "absolute left-[12%] top-[1040px] h-36 w-36 bg-teal-600 text-white ring-8 ring-teal-100",
                        "absolute left-[43%] top-[1040px] h-36 w-36 bg-blue-600 text-white ring-8 ring-blue-100",
                        "absolute left-[28%] top-[1110px] h-36 w-36 bg-purple-600 text-white ring-8 ring-purple-100",
                        "absolute left-[59%] top-[1010px] h-36 w-36 bg-red-500 text-white ring-8 ring-red-100",
                        "absolute left-[18%] top-[1280px] h-36 w-36 bg-orange-500 text-white ring-8 ring-orange-100",
                        "absolute left-[44%] top-[1325px] h-32 w-32 bg-amber-500 text-white ring-8 ring-amber-100",
                        "absolute right-[3%] top-[1290px] h-40 w-40 bg-fuchsia-600 text-white ring-8 ring-fuchsia-100",
                      ];
