...
const teamLeaderboard = [
  ...
  { name: "就是愛台灣啦", tickets: "10+", note: "持續增加中" },
  { name: "我們也來組一隊", tickets: "10+", note: "持續增加中" },
  { name: "TECO-BOSTON", tickets: "10+", note: "持續增加中" },
  { name: "Red Sox Fernando Day", tickets: "8", note: "持續增加中" },
  { name: "Need好台", tickets: "7+", note: "持續增加中" },
  { name: "Taiwanzonian-bos", tickets: "7+", note: "持續增加中" },
  { name: "Taiwan熊讚", tickets: "6+", note: "持續增加中" },
  { name: "從南到北 襪ㄧ下！", tickets: "6+", note: "持續增加中" },
  ...
  { name: "芬威要有TaiwanDay才隊", tickets: "2+", note: "持續增加中" },
  { name: "飛天少女豬", tickets: "2+", note: "持續增加中" },
];
            ...
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                ...
                <button
                  ...
                  className="rounded-full bg-amber-400 px-6 py-3 font-bold text-slate-950 shadow-md ring-2 ring-amber-100 transition hover:bg-amber-500 active:scale-95"
                >
                  💙 支持活動 GoFundMe
                </button>
                  ...
                  <div className="relative mx-auto hidden min-h-[2750px] max-w-6xl md:block">
                    {teamLeaderboard.map((team, index) => {
                      const bubbleStyles = [
                        ...
                        "absolute left-[8%] top-[125px] h-72 w-72 bg-rose-500 text-white ring-8 ring-rose-100",
                        "absolute left-[64%] top-[125px] h-72 w-72 bg-sky-600 text-white ring-8 ring-sky-100",
                        "absolute left-[37%] top-[405px] h-52 w-52 bg-blue-600 text-white ring-8 ring-blue-100",
                        "absolute left-[15%] top-[500px] h-52 w-52 bg-orange-500 text-white ring-8 ring-orange-100",
                        "absolute left-[66%] top-[500px] h-48 w-48 bg-emerald-500 text-white ring-8 ring-emerald-100",
                        "absolute left-[3%] top-[760px] h-48 w-48 bg-teal-600 text-white ring-8 ring-teal-100",
                        "absolute left-[27%] top-[720px] h-48 w-48 bg-pink-500 text-white ring-8 ring-pink-100",
                        "absolute left-[78%] top-[760px] h-44 w-44 bg-red-500 text-white ring-8 ring-red-100",
                        "absolute left-[49%] top-[650px] h-40 w-40 bg-lime-600 text-white ring-8 ring-lime-100",
                        "absolute left-[58%] top-[865px] h-40 w-40 bg-violet-600 text-white ring-8 ring-violet-100",
                        "absolute left-[11%] top-[1010px] h-40 w-40 bg-emerald-600 text-white ring-8 ring-emerald-100",
                        "absolute left-[34%] top-[1000px] h-40 w-40 bg-purple-600 text-white ring-8 ring-purple-100",
                        "absolute left-[74%] top-[1035px] h-40 w-40 bg-rose-500 text-white ring-8 ring-rose-100",
                        "absolute left-[2%] top-[1260px] h-40 w-40 bg-cyan-600 text-white ring-8 ring-cyan-100",
                        "absolute left-[25%] top-[1240px] h-40 w-40 bg-indigo-600 text-white ring-8 ring-indigo-100",
                        "absolute left-[58%] top-[1240px] h-40 w-40 bg-teal-600 text-white ring-8 ring-teal-100",
                        "absolute left-[78%] top-[1290px] h-36 w-36 bg-fuchsia-600 text-white ring-8 ring-fuchsia-100",
                        "absolute left-[14%] top-[1495px] h-36 w-36 bg-purple-600 text-white ring-8 ring-purple-100",
                        "absolute left-[39%] top-[1460px] h-36 w-36 bg-orange-500 text-white ring-8 ring-orange-100",
                        "absolute left-[63%] top-[1495px] h-36 w-36 bg-amber-500 text-white ring-8 ring-amber-100",
                        "absolute left-[82%] top-[1535px] h-36 w-36 bg-yellow-500 text-white ring-8 ring-yellow-100",
                        "absolute left-[2%] top-[1710px] h-36 w-36 bg-slate-700 text-white ring-8 ring-slate-200",
                        "absolute left-[24%] top-[1690px] h-36 w-36 bg-emerald-700 text-white ring-8 ring-emerald-100",
                        "absolute left-[47%] top-[1695px] h-36 w-36 bg-rose-500 text-white ring-8 ring-rose-100",
                        "absolute left-[80%] top-[1750px] h-36 w-36 bg-sky-600 text-white ring-8 ring-sky-100",
                        "absolute left-[9%] top-[1915px] h-36 w-36 bg-blue-600 text-white ring-8 ring-blue-100",
                        "absolute left-[33%] top-[1920px] h-36 w-36 bg-orange-500 text-white ring-8 ring-orange-100",
                        "absolute left-[61%] top-[1920px] h-36 w-36 bg-emerald-500 text-white ring-8 ring-emerald-100",
                        "absolute left-[82%] top-[2000px] h-36 w-36 bg-teal-600 text-white ring-8 ring-teal-100",
                        "absolute left-[2%] top-[2145px] h-32 w-32 bg-pink-500 text-white ring-8 ring-pink-100",
                        "absolute left-[20%] top-[2130px] h-32 w-32 bg-red-500 text-white ring-8 ring-red-100",
                        "absolute left-[39%] top-[2145px] h-32 w-32 bg-lime-600 text-white ring-8 ring-lime-100",
                        "absolute left-[61%] top-[2140px] h-32 w-32 bg-violet-600 text-white ring-8 ring-violet-100",
                        "absolute left-[81%] top-[2200px] h-32 w-32 bg-emerald-600 text-white ring-8 ring-emerald-100",
                        "absolute left-[10%] top-[2335px] h-32 w-32 bg-purple-600 text-white ring-8 ring-purple-100",
                        "absolute left-[31%] top-[2345px] h-32 w-32 bg-rose-500 text-white ring-8 ring-rose-100",
                        "absolute left-[63%] top-[2340px] h-32 w-32 bg-cyan-600 text-white ring-8 ring-cyan-100",
                      ];
